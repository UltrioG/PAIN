...
---@param nbtHash any
---@param details any
function Resource:init(type, name, mod, count, nbtHash, details)
...
---Note that for `other == nil`, for ease of use purposes this function returns false.
...
---@return boolean
function Resource:isSameResourceAs(other, setting)
